...
| | |
|---|---|
| **1,264,115** | total crawled urls，其中 **1,199,676** 次成功（94.90%） |
| **66,643,054** | total discoverd urls，丟掉約 **98%**。
...
- **推論，未直接觀測**：worker 是死掉，而非卡住之前。卡在量測區間之內會把 gauge 釘在高位，實測卻是低位；但究竟哪個例外觸發已不可考
